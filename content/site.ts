...
export const copy = {
  en: {
    ...
    viewAllWorkCount: "View all {n} projects",
    allWorkTitle: "All work",
    allWorkSubtitle:
      "Full catalog — shops, platforms, mini apps, and custom products.",
    filterAll: "All",
    projectsCount: "projects",
    moreOnAllWork: "More projects on the full portfolio page.",
    galleryTitle: "Interface Walkthrough & Screenshots",
    gallerySubtitle: "Detailed views across desktop and mobile screens",
    searchPlaceholder: "Search projects, stack, keywords...",
    noProjectsFound: "No projects match your search or filter.",
  ...
  fa: {
    ...
    viewAllWorkCount: "مشاهده همه {n} پروژه",
    allWorkTitle: "همه پروژه‌ها",
    allWorkSubtitle:
      "کاتالوگ کامل — فروشگاه، پلتفرم، مینی‌اپ و محصول اختصاصی.",
    filterAll: "همه",
    projectsCount: "پروژه",
    moreOnAllWork: "بقیه پروژه‌ها در صفحه همه نمونه‌کارها.",
    galleryTitle: "گالری تصاویر و رابط کاربری",
    gallerySubtitle: "نماهای مختلف دسکتاپ، موبایل و بخش‌های کلیدی محصول",
    searchPlaceholder: "جستجو در نام پروژه، تکنولوژی، تگ...",
    noProjectsFound: "پروژه‌ای با این فیلتر یا جستجو یافت نشد.",
    clearSearch: "پاک کردن فیلتر",
    langToggle: "FA",
    langToggleOther: "EN",
  },
} as const;
