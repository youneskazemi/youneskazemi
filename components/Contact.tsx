    ...
    <Section id="contact" title={t.contactTitle} subtitle={t.contactSubtitle}>
      ...
      >
        <a
          ...
          className="group surface-card relative min-h-[11rem] overflow-hidden p-6 transition hover:border-sky-400/35 sm:p-8"
        >
          <div
          ...
          <p className="mt-3 text-xl font-semibold tracking-tight text-zinc-50">
            {site.telegramHandle}
          </p>
          <p className="mt-2 text-sm leading-relaxed text-zinc-300">
            {t.contactFormHint}
          </p>
          <span className="mt-6 inline-flex min-h-11 items-center text-sm font-medium text-sky-300 transition group-hover:text-sky-200">
        ...
        <a
          ...
          className="group surface-card relative min-h-[11rem] overflow-hidden p-6 transition hover:border-violet-400/35 sm:p-8"
        >
          <div
          ...
          <p className="mt-3 break-all text-xl font-semibold tracking-tight text-zinc-50">
            {site.email}
          </p>
          <p className="mt-2 text-sm leading-relaxed text-zinc-300">
            {isFa
          ...
          <span className="mt-6 inline-flex min-h-11 items-center text-sm font-medium text-violet-300 transition group-hover:text-violet-200">
