...
export function MobileBottomBar() {
  ...
  const isHomeActive = pathname === "/" && (activeSection === "top" || !activeSection);
  const isWorkActive = isProjectsPage || (pathname === "/" && activeSection === "projects");
    ...
    >
      <div className="flex h-16 items-center justify-around rounded-2xl border border-white/10 bg-[#09090e]/92 px-2 shadow-[0_8px_32px_rgba(0,0,0,0.7)] backdrop-blur-2xl ring-1 ring-white/10 pb-[env(safe-area-inset-bottom,0px)]">
        ...
        >
          ...
          {isHomeActive && (
            <span className="absolute -top-1 h-1 w-1 rounded-full bg-sky-400 shadow-[0_0_6px_rgba(56,189,248,1)]" />
          )}
        </Link>
        ...
        <Link
          ...
          aria-label={isFa ? "نمونه‌کارها" : "Projects"}
        ...
        >
          <svg
            ...
            viewBox="0 0 24 24"
            stroke="currentColor"
            strokeWidth={isWorkActive ? 2.2 : 1.8}
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
        ...
        >
          <svg
            ...
            viewBox="0 0 24 24"
            stroke="currentColor"
            strokeWidth={isServicesActive ? 2.2 : 1.8}
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
        ...
        >
          <svg
            ...
            viewBox="0 0 24 24"
            stroke="currentColor"
            strokeWidth={isContactActive ? 2.2 : 1.8}
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
